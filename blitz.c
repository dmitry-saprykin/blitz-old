...
static void blitz_register_constants(INIT_FUNC_ARGS) /* {{{ */
{
    ...
    REGISTER_LONG_CONSTANT("BLITZ_NODE_TYPE_BEGIN", BLITZ_NODE_TYPE_BEGIN, BLITZ_CONSTANT_FLAGS);
    ...
    REGISTER_LONG_CONSTANT("BLITZ_NODE_TYPE_CONDITION", BLITZ_NODE_TYPE_CONDITION, BLITZ_CONSTANT_FLAGS);
    ...
    REGISTER_LONG_CONSTANT("BLITZ_NODE_TYPE_IF_NF", BLITZ_NODE_TYPE_IF_NF, BLITZ_CONSTANT_FLAGS);
    REGISTER_LONG_CONSTANT("BLITZ_NODE_TYPE_UNLESS_NF", BLITZ_NODE_TYPE_UNLESS_NF, BLITZ_CONSTANT_FLAGS);
    ...
    REGISTER_LONG_CONSTANT("BLITZ_NODE_TYPE_ELSEIF_NF", BLITZ_NODE_TYPE_ELSEIF_NF, BLITZ_CONSTANT_FLAGS);
    REGISTER_LONG_CONSTANT("BLITZ_NODE_TYPE_ELSEIF_CONTEXT", BLITZ_NODE_TYPE_ELSEIF_CONTEXT, BLITZ_CONSTANT_FLAGS);
    REGISTER_LONG_CONSTANT("BLITZ_NODE_TYPE_ELSE_NF", BLITZ_NODE_TYPE_ELSE_NF, BLITZ_CONSTANT_FLAGS);
